...
export const tendrginPreviewSection = document.querySelector("#trendingPreview");
...
export const trendinMoviesPreviewList = document.querySelector(".trendingPreview-movieList");
